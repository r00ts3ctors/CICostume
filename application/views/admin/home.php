      ...
      <div class="table-wrap">
        <div class="table-responsive">
          <table class="table table-sm table-hover mb-0">
            ...
            <tbody>
              <tr>
                <td><img class="img-fluid rounded" src="<?php echo base_url('assets/template/backend/'); ?>dist/img/logo1.jpg" alt="icon"></td>
                <td>Branding</td>
                <td>Pineapple Inc</td>
                <td>13 Nov 2018</td>
              ...
              <tr>
                <td><img class="img-fluid rounded" src="<?php echo base_url('assets/template/backend/'); ?>dist/img/logo2.jpg" alt="icon"></td>
                <td>Website</td>
                <td>Gooole co.</td>
                <td>30 Nov 2018</td>
              ...
              <tr>
                <td><img class="img-fluid rounded" src="<?php echo base_url('assets/template/backend/'); ?>dist/img/logo3.jpg" alt="icon"></td>
                <td>Collaterals</td>
                <td>Big Energy</td>
                <td>12 Nov 2018</td>
              ...
              <tr>
                <td><img class="img-fluid rounded" src="<?php echo base_url('assets/template/backend/'); ?>dist/img/logo4.jpg" alt="icon"></td>
              ...
              <tr>
                <td><img class="img-fluid rounded" src="<?php echo base_url('assets/template/backend/'); ?>dist/img/logo5.jpg" alt="icon"></td>
